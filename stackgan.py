...
Original file is located at
    https://colab.research.google.com/drive/15b_rm12CO7Kj8pbkYRSGyQI8uMnJXRsu
"""
...
def checkpoint_prefix():
	checkpoint_dir = './content/drive/training_checkpoints'
...
def load_data(filename_path, class_id_path, dataset_path, embeddings_path, size):
	"""Loads the Dataset.
	"""
	data_dir = "./content/drive/birds_implementation/birds"
...
class StackGanStage1(object):
  ...
  class_id_path_test = test_dir + "/class_info.pickle"
  dataset_path = "./content/drive/birds_implementation/CUB_200_2011"
  def __init__(self, epochs=10, z_dim=100, batch_size=200, enable_function=True, stage1_generator_lr=0.0002, stage1_discriminator_lr=0.0002):
	  self.epochs = epochs
	  self.z_dim = z_dim
    ...
    """
	  ...
	  for epoch in range(self.epochs):
		  ...
		  for i in range(num_batches):
		    ...
		    if epoch % 25 == 0:
		      self.stage1_generator.save_weights('./content/drive/weights/stage1_gen.h5')
		      self.stage1_discriminator.save_weights("./content/drive/weights/stage1_disc.h5")
		      self.ca_network.save_weights('./content/drive/weights/stage1_ca.h5')
		      self.embedding_compressor.save_weights('./content/drive/weights/stage1_embco.h5')
		      self.stage1_adversarial.save_weights('./content/drive/weights/stage1_adv.h5')
...
class StackGanStage2(object):
	...
	class_id_path_test = test_dir + "/class_info.pickle"
	dataset_path = "./content/drive/birds_implementation/CUB_200_2011"
	def __init__(self, epochs=10, z_dim=100, batch_size=50, enable_function=True, stage2_generator_lr=0.0002, stage2_discriminator_lr=0.0002):
		self.epochs = epochs
		self.z_dim = z_dim
		self.enable_function = enable_function
		self.stage2_generator_lr = stage2_generator_lr
		self.stage2_discriminator_lr = stage2_discriminator_lr
		...
		for epoch in range(self.epochs):
			...
			for i in range(num_batches):
				...
				if epoch % 10 == 0:
					...
					self.embedding_compressor.save_weights('./content/drive/weights/stage2_embco.h5')
					self.stage2_adversarial.save_weights('./content/drive/weights/stage2_adv.h5')
